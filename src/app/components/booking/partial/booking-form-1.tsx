          ...
          <form className="" action="#">
            <div className="flex justify-between w-full">
              <div className="relative w-[48%]">
                ...
                <CommonInput type="text" name="text" id="firstname" placeholder="First name" required={true} />
              </div>
              <div className="relative w-[48%]">
                ...
                <CommonInput type="text" name="text" id="lastname" placeholder="Last name" required={true} />
              </div>
            </div>
            <div className="relative w-full mt-6">
              ...
              <CommonInput type="email" name="email" id="email" placeholder="Email" required={true} />
            </div>
            ...
            <div className="relative w-full mt-6">
              ...
              <CommonInput type="text" name="text" id="billingAddress" placeholder="Billing Address" required={true} />
            </div>
            <div className="flex justify-between w-full mt-6">
              <div className="relative w-[48%]">
                ...
                <CommonInput type="number" name="number" id="adultNumber" placeholder="Adult number" required={false} />
              </div>
              <div className="relative w-[48%]">
                ...
                <CommonInput type="number" name="number" id="kidsNumber" placeholder="Kids number" required={false} />
              </div>
            </div>
