          ...
          <form className="" action="#">
            ...
            <div className="mt-6 flex items-baseline">
              <div className="flex items-center mb-4">
                ...
                <label className="ms-2 md:text-base text-sm  text-black">We eat on board</label>
              </div>
              <div className="flex items-center ml-10">
                ...
                <label className="ms-2 md:text-base text-sm  text-black">We eat on a restaurant</label>
              </div>
            </div>
