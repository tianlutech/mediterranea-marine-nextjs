    ...
    <Modal isOpen={isOpen} onClose={() => closeModal()}>
      <div className="relative p-2 md:w-[60%] bg-white rounded-lg shadow overflow-y-scroll pt-0 w-[95%] h-[95%] md:px-12 px-2">
        ...
        <div className="text-black mx-4">
          <div className="flex justify-center border-black  mb-4">
            <p className="text-base font-bold text-black justify-center text-center">
              CHARACTER AGREEMENT
            </p>
          </div>
          <div className="pt-4 md:pt-5 text-black text-sm">
            <p className="">
              In the boatName on the XXX of the XXXX of the year two thousand twenty twenty four
            </p>
          </div>
          <div className="border-b border-black mb-4 mt-6">
            <p className="text-sm font-bold ">PART OF THE AGREEMENT</p>
          </div>
          <div className="mb-4 mt-6">
            <p className="text-sm font-semibold">From the other side. -</p>
          </div>
          <p className="text-sm mb-4">
            MR DAVID MARTINEZ KANSY, of legal age, with address for these purposes at C. SAN LEANDRO No.8 1B RIGHT,
            30204 Cartagena, with ID number 74377963b, acting on behalf of the company REAL ESTATE AND MARINE MANAGEMENT,
            SL, domiciled in Cartagena, C/San Leandro 8; Esc Izda, 1st B, and provided with CIF B-30933832.<br />
          </p>
          <p className="text-sm mb-4">
            Its faculites for this act emanate from the constitution deed itself.
          </p>
          <p className="text-sm mb-4">
            From now on THE MANAGER
          </p>
          <div className="mb-4 mt-6">
            <p className="text-sm font-semibold">From the other side</p>
          </div>
          <p className="text-sm mb-4">
            Mr/Mrs XXXXXXXXXX, of legal age, with address for these purpose at XXXXXX, with ID/PASSPORT number From now on THE LESSEE
          </p>
          <div className="mt-16 text-sm">
            <p>Name of the boat: XXX</p>
            <p>Kind: XXX</p>
            <p>Registration port: XXX</p>
            <p>Flag: XXX</p>
            <p>Registration plate: XXX</p>
            <p>Base port: XXX</p>
          </div>
          <div className="mt-10 border-1 border-b border-black w-[25%] text-sm">
            CHARACTER DETAILS
          </div>
          <div className="mt-5 border-1 border-black text-sm">
            CHARACTER PERIOD:
          </div>
          <div className="mt-5">
            <p className="text-sm">
          ...
          <div className="mt-10 text-sm">
            <p>Delivery port: XXX</p>
            <p>Port of disembark: XXX</p>
            <p>Maximum number of guest cruising on board X</p>
            <p>Crew composed of: Captain</p>
          </div>
          <div className="mt-5 border-1 border-black text-sm">
            CHARACTER PRICE:
            <p className="text-sm">
              taxable base: XXX $, VAT: XXX $, Total rental rate: XXX $
            </p>
          </div>
          <div className="my-10 text-sm">
            <p>Real Estate and Marine Management S.L</p>
            <p>VAT No B-30933832</p>
            <p>C/ San Leandro 8 Esc Iz 1 B 30204 Cartagena - Murcia</p>
            <p className="mt-2">Bank Sabadell</p>
            <p className="mt-2">Account No ES6100810687760002151422</p>
            <p className="mt-2">SWIFT o BIC: BSABESBB</p>
          </div>
