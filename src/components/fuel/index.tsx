...
export default function Fuel() {
  ...
  const [data, setData] = useState({
    ...
    Captain: "",
    Port: "",
    "Picture of the Reciept": {} as File
  });
  ...
  const submitFuelForm = async () => {
    setLoading(true)
    const uploadReceiptImage = await storeReceiptImage(data["Picture of the Reciept"])
    if (!uploadReceiptImage) {
      toast.error(t("upload_front_image"));
      setLoading(false);
      return;
    }
    storeReceiptImage(data["Picture of the Reciept"])
    // we continue here with the function to update table
  }
          ...
          <div className="md:p-6 sm:p-8 p-6">
            <div className="flex md:flex-row flex-col justify-between w-full mt-6">
              ...
              <FormWrapper>
                ...
                <SelectBoat data={data} setData={setData} setLoading={setLoading} />
              </FormWrapper>
            </div>
            <div className="flex md:flex-row flex-col justify-between w-full md:mt-6 mt-0">
              ...
              <FormWrapper>
                ...
                <SelectCaptain data={data} setData={setData} setLoading={setLoading} />
              </FormWrapper>
            </div>
            ...
            <>
              <CommonInputFile
                ...
                onRemove={() => setData({ ...data, "Picture of the Reciept": {} as File })}
                onChange={(file) => setData({ ...data, "Picture of the Reciept": file })}
                required
              />
            </>
            <SubmitButton
